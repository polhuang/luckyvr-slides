...
const comparisonData = [
  {
    ...
    features: [
      ...
      { name: "Audit Logs & SIEM Integration", pro: false, enterprise: true },
      { name: "SCIM & Directory Sync", pro: false, enterprise: true },
      { name: "SAML Single Sign-On", pro: "Add-on ($300/mo)", enterprise: true },
      { name: "HIPAA BAA", pro: "Add-on ($350/mo)", enterprise: true },
      { name: "Project-level RBAC", pro: false, enterprise: true },
  ...
  },
  {
    ...
    features: [
      { name: "SLA", pro: false, enterprise: "99.99%" },
      { name: "Support with SLA", pro: false, enterprise: true },
      { name: "Custom Limits", pro: false, enterprise: true },
    ],
  },
]
